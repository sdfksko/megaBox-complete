...
public class CalendarEx {
	...
	public static void main(String[] args) {
		List<CalendarDTO> li = CalendarEx.prn(2024, 8, 1);
		for(var l : li) {
	...
	public static List<CalendarDTO> prn(int year, int month, int day) {
		...
		int start = CalendarEx.getDayOfWeek(year, month);
		...
		if (li.size() < 14) {
			int end2 = CalendarEx.getDate(year, month + 1);
			int start2 = CalendarEx.getDayOfWeek(year, month+1);
